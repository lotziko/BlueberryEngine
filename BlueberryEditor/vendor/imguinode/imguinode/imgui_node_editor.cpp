...
ed::Control ed::EditorContext::BuildControl(bool allowOffscreen)
{
    ...
    auto isMouseDoubleClickOverBackground = [doubleClickedObject, backgroundExtraFlags]() -> int
    {
        ...
        if ((backgroundExtraFlags & ImGuiButtonFlags_MouseButtonLeft)   && ImGui::IsMouseDoubleClicked(ImGuiMouseButton_Left))   return ImGuiMouseButton_Left;
        if ((backgroundExtraFlags & ImGuiButtonFlags_MouseButtonRight)  && ImGui::IsMouseDoubleClicked(ImGuiMouseButton_Right))  return ImGuiMouseButton_Right;
        if ((backgroundExtraFlags & ImGuiButtonFlags_MouseButtonMiddle) && ImGui::IsMouseDoubleClicked(ImGuiMouseButton_Middle)) return ImGuiMouseButton_Middle;
