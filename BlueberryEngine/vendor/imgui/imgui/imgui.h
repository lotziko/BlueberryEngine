...
namespace ImGui
{
    IMGUI_API unsigned int GetDockNodeDataCount();
    IMGUI_API void PrepareWindowData();
    IMGUI_API void PrepareDockNodeData();
    IMGUI_API void ReadRawWindowData(const char* title, char* target);
    IMGUI_API void WriteRawWindowData(const char* title, char* source);
    IMGUI_API void ReadRawDockNodeData(int index, char* target);
    IMGUI_API void WriteRawDockNodeData(char* source);
    IMGUI_API void ApplyWindowAndDockNodeData();
}
