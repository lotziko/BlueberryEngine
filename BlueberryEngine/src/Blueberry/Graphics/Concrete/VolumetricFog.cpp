...
namespace Blueberry
{
	...
	GfxTexture* VolumetricFog::s_FrustumVolume2 = nullptr;
	ObjectId VolumetricFog::s_CameraId = 0;
	...
	void VolumetricFog::Initialize()
	{
		...
		GfxDevice::CreateTexture(textureProperties, s_FrustumVolume2);
	}
